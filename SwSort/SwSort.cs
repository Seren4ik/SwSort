    ...
    public class SwSort : SwAddInEx
    {
        ...
        private void GetInfo(IModelDoc2 swModel, string path1)
        {
            ...
            else if (type1.Contains("Лист ПВЛ"))
            {
                ...
                #endregion
                #region Полоса Квадрат
                else if (type1 == "Полоса" || type1 == "Квадрат")
                {
                    if (type1 == "Квадрат")
                    {
            ...
            #endregion
            #region Брусок Доска Брус
            else if (type1 == "Брусок" || type1 == "Доска" || type1 == "Брус клееный")
            {
                if (type1 == "Брусок" || type1 == "Доска")
                {
                    string typesort = type1 + " " + "2-хв.-" + widht + "х" + tolsh1;

                    OpenExcelFile(path1, typesort, nameConf, swModel);
                }
                else if (type1 == "Брус клееный")
                {
                    string typesort = type1 + " " + widht + "х" + tolsh1;
